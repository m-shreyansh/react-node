...
setusername(null)
  ...
  useEffect(()=>{
    ...
    return (
        ...
        (
      <Router>
          <Newnavbar username={username} logMeOut={meow}/>
          <div className="Body" id="main">

       
          <Route path="/" exact component={() => (<Home username={username} />)}/>
          <Route path={"/login"} exact component={() => (<Usercomponent username={username} />)}/>
          <Route path="/register" exact component={Register}/>
          <Route path="/profile" component={() => (<Profile username={username} />)}/>
          <Route path="/blog" component={() => (<ReadBlog username={username} />)}/>
          <Route path="/newblog" component={() => (<NewBlog username={username} />)}/>
          <Route path="/editblog" component={() => (<EditBlog username={username} />)}/>          
